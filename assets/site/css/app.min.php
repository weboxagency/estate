...
.bg-primary {
    background-color: #d3a033 !important;
}
...
.link-button--tertiary {
    ...
    border-radius: 20px;
    background-color: rgb(211 160 51 / 16%);
    color: #d3a033 !important;
    font-weight: 500;
    height: 40px;
    padding-left: 20px;
...
.link-button--quaternary {
    ...
    -webkit-border-radius: 20px;
    border-radius: 20px;
    border: 2px solid rgb(211 160 51 / 16%);
    padding-left: 16px;
    padding-right: 25px;
    color: #d3a033;
    font-weight: 500;
...
.select2-container--default
    ...
    b {
    border-color: #d3a033 transparent transparent transparent;
    border-style: solid;
...
.announcement .announcement-icons .shape:last-child {
...
.account
    ...
    .check-button
    .active-check {
    border: 2px solid #d3a033 !important;
}
...
.calendar
    ...
    .table-col.clickable:hover
    .table-value-wrapper {
    background: rgb(211 160 51 / 16%) !important;
}
...
.calendar
    ...
    .table-value-wrapper {
    background-color: rgb(211 160 51 / 16%) !important;
}
