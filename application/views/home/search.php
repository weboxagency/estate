<main class="main">
	<section class="map">
	   <div class="main-header__content container map-content page-container">
	     <form x-search-form class="search" action="<?= base_url() ?>axtar" method="get">
	         ...
	         <input type="hidden" name="region" value="<?= (isset($_GET['region'])) ? $_GET['region'] : '' ?>">
	         <input type="hidden" name="district" value="<?= (isset($_GET['district'])) ? $_GET['district'] : '' ?>">
	         <input type="hidden" name="metro" value="<?= (isset($_GET['metro'])) ? $_GET['metro'] : '' ?>">
	         ...
	         <div class="search-first">
	            <select class="search-select p-0" type-select name="type">
	               ...
	               <option value="<?= $value['id'] ?>" <?= ($value['id']==$_GET['type']) ? "selected" : ''; ?>><?= $value['type_name'] ?></option>
	                <?php endforeach; ?>
	            </select>
	                  ...
	                  <div class="modal-content">
	                     <div class="modal-header">
	                        <select class="form-control select2-modal" name="city">
	                           ...
	                           <option value="<?= $value['id'] ?>" <?= ($value['id']==$_GET['city']) ? "selected" : ''; ?>><?= $value['city_name']; ?></option>
	                           <?php endforeach; ?>
	                        </select>
	                        <div class="modal-close" data-dismiss="modal">
	                           <svg class="icon icon-close">
	                        ...
	                        <div class="modal-body__content">
	                           <div class="region-container">
	                              ...
	                              <div class="region" x-city="<?= $value['parent_city'] ?>">
	                                 <p class="region-title region-<?= $value['id'] ?> <?= ($value['id']==$_GET['region']) ? "active" : ''; ?>">
	                                 ...
	                                 <?php foreach ($district as $dis_value): ?>
	                                    <?php if ($value['id'] === $dis_value['parent_region']) { ?>
	                                         <p class="region-part district-<?= $dis_value['id'] ?> <?= ($value['id']==$_GET['district']) ? "active" : ''; ?>">
	                           ...
	                           <ul class="region-list" id="metro-list">
	                              <li class="region">
	                                <?php foreach ($metros as $value): ?>
	                                 <div class="pretty pretty-checkbox p-icon p-curve p-jelly" id="station-<?= $value['id'] ?> <?= ($value['id']==$_GET['metro']) ? "active" : ''; ?>">
	                                    <input type="checkbox" />
	                                    <div class="state p-primary">
	                                       <i class="icon fa fa-check"></i>
	                                       <label></label>
	...
	<section class="main-body page-container container">
	   	<div class="announcement-group">
		      ...
		      <h5 class="announcement-title"><?= translate('searching_results') ?> : <?= count($new_ads_list) ?> elan</h5>
		   	</div>
