					...
					<div class="form-group mt-md">
						...
						<div class="col-md-6">
							<textarea name="content" class="form-control summernote" id="summernote" name="content">
								<?= $add_advertisement_rules['content']; ?>
							</textarea>
					...
					<div class="form-group mt-md">
						...
						<div class="col-md-6">
							<select class="form-control" name="status" id="status">
								...
								<option value="0" <?= ($add_advertisement_rules['status']==0) ? 'selected' : '' ?>><?= translate('deactive') ?></option>
								<option value="1" <?= ($add_advertisement_rules['status']==1) ? 'selected' : '' ?>><?= translate('active') ?></option>
							</select>
