...
class Ads_configuration_model extends MY_Model
{
    ...
    public function getAdsConfigurations()
    {
        $this->db->select('*');
        $this->db->from('ads_configuration');
        $query = $this->db->get();
        return $query->result_array();
    }

    public function ads_configuration_edit($data)
    {
        $ads_conf = array(
